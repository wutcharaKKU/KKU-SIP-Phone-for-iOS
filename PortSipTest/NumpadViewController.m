...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [_buttonLine setTitle:[NSString  stringWithFormat:@"Line%zd:", appDelegate.activeLine ] forState:UIControlStateNormal];
...
- (IBAction) onButtonClick: (id)sender
{
	...
	switch (tag) {
        ...
        {
			_textNumber.text = [_textNumber.text stringByAppendingString:[NSString stringWithFormat:@"%zd", (long)tag]];
